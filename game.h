...
class Game {
	...
	public:	
		/** 
		 *	\brief This Function prints out the winner of the fight.
		 *	\param attacker Attacking unit of the fight
		 *	\param deffeder Defending unit of the fight
		*/
		...
		void addCharacter(const std::string& fname/** [in] File name of Unit .json or string data of the Unit*/);
};
#endif
